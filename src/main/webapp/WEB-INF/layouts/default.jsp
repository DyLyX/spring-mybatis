...
<link href="${ctx}/static/css/combo.select.css" type="text/css" rel="stylesheet" />
<style type="text/css">
...
<script type="text/javascript" src="${ctx}/static/jquery/ui/jquery.combo.select.js"></script>
<sitemesh:head/>
</head>
<body class="main_bg">
